...
public class C3P0 {
	...
	public C3P0() {
		try {
			...
			props.load(C3P0.class.getClassLoader().getResourceAsStream("config.properties"));
	...
	public static void main(String[] args) {
		...
		Connection connection = C3P0.c3P0Properties.getConnection();
